...
const controller = __importStar(require("../../controllers/admin/singer.controllers"));
...
router.patch("/editPost/:id", upload.single("avatar"), uploadCloud_middleware_1.uploadSingle, controller.editPost);
